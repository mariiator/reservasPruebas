...
class uphpCAS {
	const VERSION = '2.0';
	protected $serverUrl = 'https://login01.globaleduca.es/mi010';
	protected $serviceUrl = 'https://pruebas.maristaschamberi.com/reservas.php';
	protected $sessionName = 'mi010';
	...
	public function getCurrentUrl() {
		$url = 'http://login01.globaleduca.es/mi010';
		$port = 443;
		if(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') {
			$url = 'https://login01.globaleduca.es/mi010';
	...
	public function loginUrl() {
		return $this->serverUrl . '/login?method=' . $this->method . '&service=' . urlencode('https://login01.globaleduca.es/mi010');
	}
	...
	public function authenticate() {
		...
		if ($this->isAuthenticated()) {
			...
			header('Location: https://pruebas.maristaschamberi.com/reservas.php');
			exit;
		} else {
