...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Recoger el nombre de la sala
    $nombre_sala = mysqli_real_escape_string($conn, $_POST['nombre_sala']);

    // Insertar la sala en la base de datos
    $query = "INSERT INTO espacios (nombre) VALUES ('$nombre_sala')";
    if (mysqli_query($conn, $query)) {
        echo "<script>alert('Sala añadida correctamente'); window.location.href = 'administrar_salas.php';</script>";
    } else {
...
<div class="container">
    ...
    <form method="POST" action="añadir_salas.php">
